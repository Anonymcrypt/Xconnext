...
import { Wallet, ConnectedWallet } from '@/libs/types/wallets';

// Mock wallet data to get wallet info
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl text-white mb-4">Wallet not found</h1>
          <button 
            onClick={() => router.back()}
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400">Connect to {wallet.name}</p>
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-gray-900 bg-opacity-50 rounded-xl">
          <p className="text-xs text-gray-400 text-center">
            Your credentials are stored securely locally and never shared with third parties
          </p>
        </div>
      </div>
    </div>
